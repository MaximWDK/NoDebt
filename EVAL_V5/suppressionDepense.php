<?php ob_start(); $statut='tout'; $nomPage='Suppression Dépense Groupe'; require 'inc/checkConnexion.php'; require 'inc/header.inc.php'; require 'php/suppressionDepense.inc.php'?>
        <main>
